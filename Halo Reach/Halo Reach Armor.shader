...
Shader "Ketcham1009/Halo Reach/Armor"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			o.Albedo = ( tex2D( _Texture, uv_Texture ) * ( ( _PrimaryColor * tex2DNode3.r ) + ( _SecondaryColor * tex2DNode3.g ) + ( 1.0 - ( tex2DNode3.r + tex2DNode3.g + tex2DNode3.b ) ) ) ).rgb;
...
/*ASEBEGIN
Version=18800
2644;-92;2535;1363;1744.128;724.5854;1;True;True
...
ASEEND*/
//CHKSM=694D5373D585AA3068BFAF332A02F6ACB9985665