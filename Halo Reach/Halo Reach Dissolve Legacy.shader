...
Shader "Ketcham1009/Halo Reach/Armor + Dissolve Legacy"
{
	Properties
	{
		...
		_DisolveMaxThreshold("Disolve Max Threshold", Range( 1 , 10)) = 10
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float temp_output_158_0 = ( 1.0 - _Disolveamountalt );
			...
			float4 lerpResult179 = lerp( color176 , _DisolveEdge , (0.0 + (_Disolveamountalt - 0.0) * (1.0 - 0.0) / (0.01 - 0.0)));
			float4 ifLocalVar182 = 0;
			if( _Disolveamountalt <= 0.05 )
			...
			float4 Opacity181 = ( ( tex2D( _Dissolve, uv_Dissolve ) + (_DisolveMinThreshold + (DisolveAmount162 - 0.0) * (_DisolveMaxThreshold - _DisolveMinThreshold) / (1.0 - 0.0)) ) + ( LocalPositionGradient166 * _GradientPower ) );
...
/*ASEBEGIN
Version=18800
2560;-27;1080;1357;1778.326;969.4017;1.775155;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;138;-1366.715,702.3817;Inherit;False;Property;_Disolveamountalt;Disolve amount alt;9;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;164;-2486.531,1139.123;Inherit;False;Property;_DisolveMaxThreshold;Disolve Max Threshold;12;0;Create;True;0;0;0;False;0;False;10;10;1;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;116;-1557.459,-323.8307;Inherit;False;Property;_Primary;Primary;4;0;Create;True;0;0;0;False;0;False;0,0.2039213,1,1;0.1411764,0.5372549,0.6588235,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=A70B7BF24802E1481CE37C2DB92A57AD5C1CEAF4